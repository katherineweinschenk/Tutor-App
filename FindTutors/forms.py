...
# from django import forms
# from django.contrib.auth.forms import UserCreationForm
# from .models import TUser, Profile, Reviews, Request
# from django.forms import ModelForm
# from django.contrib.auth.models import User
# from crispy_forms.helper import FormHelper
# from crispy_forms.layout import Layout, Div, Submit, HTML, Button, Row, Field
...
#         self.fields['firstname'].label = ""
#         self.helper.field_class = "md-form col-lg-10 ml-4"
#         self.helper.layout = Layout(Field('firstname', css_class="col-lg-12", placeholder="First Name"), 'lastname',
#                                     'email',
#                                     'phone_number', 'year', 'subjects', 'bio', 'image' )
#         self.helper.all().wrap(Div, css_class="md-form")
#         self.helper.layout[0].append(
#             HTML('<i class="fa fa-envelope prefix envelope"></i>'))
#
...
#             'firstname': 'First Name',
#             'lastname': 'Last Name', 'email': 'Email',
#             'phone_number': 'Phone Number', 'year': 'Years Teaching', 'subjects': 'Subjects', 'bio': 'About Me', 'image': 'Profile Picture',
#         }
#
#
# class TuteeUserSignUpForm(UserCreationForm):
